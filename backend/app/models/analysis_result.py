...
class AnalysisResult(Base):
    ...
    # Vision futura (trazabilidad de que version del script de analisis genero
    # este resultado, ver auditoria): nadie la puebla todavia -- analysis_job.py
    # no la setea -- se agrega ahora para no migrar de nuevo mas adelante.
